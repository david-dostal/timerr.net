...
!function (a, b) {
  ...
  }();var t = { elements: n.elements || "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template decomposeTime video", version: m, shivCSS: n.shivCSS !== !1, supportsUnknownElements: l, shivMethods: n.shivMethods !== !1, type: "default", shivDocument: j, createElement: g, createDocumentFragment: h, addElements: e };a.html5 = t, j(b), "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports && (module.exports = t);
...
/*! Module: rem - v1.3.2 | Copyright (c) 2014 Chuck Carpenter <chuck.carpenter@me.com>,Lucas Serven <lserven@gmail.com>; */
!function (e) {
  "use strict";

  var t = function t() {
    var e = document.createElement("div");return e.style.cssText = "font-size: 1rem;", /rem/.test(e.style.fontSize);
  },
      n = function n() {
    ...
    for (var e = /[\w\d\s\-\/\\%#:,.'"*()]+\d*\.?\d+rem[\w\d\s\-\/\\%#:!,.'"*()]*[;}]/g, t = 0; t < f.length; t++) {
      u += f[t].substr(0, f[t].indexOf("{") + 1);for (var n = f[t].match(e), r = 0; r < n.length; r++) {
        u += n[r], r === n.length - 1 && "}" !== u[u.length - 1] && (u += "\n}");
      }
    }s();
  },
      s = function s() {
    ...
    }var t = document.createElement("style");t.setAttribute("type", "text/css"), t.id = "remReplace", document.getElementsByTagName("head")[0].appendChild(t), t.styleSheet ? t.styleSheet.cssText = u : t.appendChild(document.createTextNode(u));
  },
      l = function l(t, n) {
    try {
      var r = e.ActiveXObject ? new ActiveXObject("Microsoft.XMLHTTP") || new ActiveXObject("Msxml2.XMLHTTP") : new XMLHttpRequest();r.open("GET", t, !0), r.onreadystatechange = function () {
        4 === r.readyState && n(r, t);
      }, r.send(null);
    } catch (o) {
      if (e.XDomainRequest) {
        var a = new XDomainRequest();a.open("get", t), a.onload = function () {
          n(a, t);
        }, a.onerror = function () {
          return !1;
        }, a.send();
    ...
    var u = "",
      ...
      var e,
          ...
          i = r.style.fontSize;return o && n.appendChild(r), a.style.cssText = "width:1em; position:absolute; visibility:hidden; padding: 0;", r.style.fontSize = "1em", r.appendChild(a), e = a.offsetWidth, o ? n.removeChild(r) : (r.removeChild(a), r.style.fontSize = i), e;
    }(), r();
  }
}(window);
...
(function () {
  var e, t, n, r, o, i, u, c, l, a, h;e = [function () {
    ...
    var t, n;for (n = !1, t = 0; t < e.length;) {
      try {
        n = e[t++]();
      } catch (e) {
        e;continue;
    ...
    var n, r;(r = i()).onreadystatechange = function () {
      if (4 === r.readyState) {
        if (200 !== r.status && !e.match(/^file:\/\/\//)) throw "Error!";console.log("INFO: processing " + e), _t(r.responseText);
      }
    };try {
      r.open("GET", e, !0), r.send();
    } catch (t) {
      n = t, console.log("ERROR: " + n.message + " (" + n.type + ") when accessing " + e);
    }
  }, u = function u() {
    var e, t;return e = 0, t = 0, window.innerHeight ? (e = window.innerWidth, t = window.innerHeight) : document.documentElement && document.documentElement.clientHeight ? (e = document.documentElement.clientWidth, t = document.documentElement.clientHeight) : document.body && (e = document.body.clientWidth, t = document.body.clientHeight), { width: e, height: t };
  }, r = function r() {
    var e, t, n, r, o;return (r = document.createElement("div")).id = "vminpolyTests", (e = document.getElementsByTagName("body")[0]).appendChild(r), n = document.createElement("style"), (t = document.getElementsByTagName("head")[0]).appendChild(n), o = h(r, n) && h(r, n) && a(r, n), e.removeChild(r), t.removeChild(n), o;
  }, l = function l(e) {
    return window.getComputedStyle ? getComputedStyle(e, null) : e.currentStyle;
  }, n = function n(e, t) {
    var n, r;return n = "#vminpolyTests { " + t + "; }", e.styleSheet ? e.styleSheet.cssText = n : (r = document.createTextNode(n), e.appendChild(r));
  }, o = function o(e) {
    return e.styleSheet ? e.styleSheet.cssText = "" : e.innerHTML = "";
  }, h = function h(e, t) {
    var r, i;return n(t, "width: 50vw"), i = parseInt(window.innerWidth / 2, 10), r = parseInt(l(e).width, 10), o(t), r === i;
  }, a = function a(e, t) {
    var r, i, u, c, a;return n(t, "width: 50vmin"), a = (u = document.documentElement).clientWidth / 100, c = u.clientHeight / 100, r = parseInt(50 * Math.min(a, c), 10), i = parseInt(l(e).width, 10), o(t), r === i;
  }, c = function c() {
    var e, _n, r, o, i, c, l, a, h, s;for (e = function e(_e) {
      var t, n, r, o, i, u, c, l, a, h;for (n = [], i = 0, c = (a = _e.value).length; i < c; i++) {
        for (r = !1, u = 0, l = (h = (t = a[i]).value).length; u < l; u++) {
          "DIMENSION" !== (o = h[u]).tokenType || "vmin" !== o.unit && "vh" !== o.unit && "vw" !== o.unit || (r = !0);
        }r && n.push(t);
      }return _e.value = n, n;
    }, _n = function n(t) {
      var r, o, i, u, c;for (o = [], i = 0, u = (c = t.value).length; i < u; i++) {
        switch ((r = c[i]).type) {case "STYLE-RULE":
            0 !== e(r).length && o.push(r);break;case "AT-RULE":
            0 !== _n(r).length && o.push(r);}
      }return t.value = o, o;
    }, i = function i() {
      var e, t, n, _r, o, i, c, h, s;s = u(), (t = { vh: s.height / 100, vw: s.width / 100 }).vmin = Math.min(t.vh, t.vw), h = s.width / s.height, o = function o(e, t) {
        var n, r, o, i;if (null != e.map) return e.map(t);for (n = [], o = 0, i = e.length; o < i; o++) {
          r = e[o], n.push(t(r));
        }return n;
      }, n = function n(e) {
        var n, r, i, u, c, l, a, h, s;for ([], r = o(e.selector, function (e) {
          return null != e.toSourceString ? e.toSourceString() : "";
        }).join(""), r += "{", u = 0, l = (h = e.value).length; u < l; u++) {
          for (r += (n = h[u]).name, r += ":", c = 0, a = (s = n.value).length; c < a; c++) {
            "DIMENSION" !== (i = s[c]).tokenType || "vmin" !== i.unit && "vh" !== i.unit && "vw" !== i.unit ? r += i.toSourceString() : r += Math.floor(i.num * t[i.unit]) + "px";
          }r += ";";
        }return r += "}\r";
      }, _r = function r(e) {
        var t, i, u, c, l, a, s, d, m, g, f, v, p, w, y, S, T, E, M;for (c = "", d = 0, v = (S = e.value).length; d < v; d++) {
          switch ((u = S[d]).type) {case "STYLE-RULE":
              c += n(u);break;case "AT-RULE":
              if ("media" === u.name) {
                for (i = "", !1, t = [], m = 0, p = (T = u.prelude).length; m < p; m++) {
                  if ("(" === (a = T[m]).name) {
                    for (i += "(", g = 0, w = (E = a.value).length; g < w; g++) {
                      l = null != (s = E[g]).toSourceString ? s.toSourceString() : "", "IDENT" === s.tokenType && "max-aspect-ratio" === l && !0, "NUMBER" === s.tokenType && t.push(parseInt(l)), i += l;
                    }i += ")";
                  } else i += a.toSourceString();
                }h < t[0] / t[1] && (c += _r(u));
              } else {
                for (i = "", f = 0, y = (M = u.prelude).length; f < y; f++) {
                  "(" === (a = M[f]).name ? (i += "(", i += o(a.value, function (e) {
                    return null != e.toSourceString ? e.toSourceString() : "";
                  }).join(""), i += ")") : i += a.toSourceString();
                }c += "@" + u.name + " " + i + " {", c += _r(u), c += "}\n";
              }}
        }return c;
      }, e = "";for (c in l) {
        i = l[c], e += _r(i);
      }return null != a.styleSheet ? a.styleSheet.cssText = e : a.innerHTML = e;
    }, l = {}, a = document.createElement("style"), document.getElementsByTagName("head")[0].appendChild(a), o = document.getElementsByTagName("link"), r = 0, c = 0, h = 0, s = o.length; h < s; h++) {
      !function () {
        var e = o[h];"stylesheet" === e.rel && (r++, t(e.href, function (t) {
          var o, i;i = tokenize(t), o = parse(i), _n(o), l[e.href] = o, ++c === r && window.onresize();
        }));
      }();
    }window.onresize = i;
  }, console.log("About to do the engine unless...", r()), r() || c();
}).call(undefined);
